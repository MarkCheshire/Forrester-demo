-- 1c5beed33198e5b79e520f837256b78d http://api.2445580546262.proxy.3scale.net:80 https://hello-world-api.3scale.net:443 2555417696872 hello-world-api.3scale.net --
-- -*- mode: lua; -*-
-- Generated on: 2014-01-28 14:12:31 +0000 --
-- Version:
-- Error Messages per service

      service_2555417696872 = {
...
matched_rules2 = ""
        ...
        function extract_usage_2555417696872(request)
...
function get_debug_value()
   ...
   if h["X-3scale-debug"] == '1c5beed33198e5b79e520f837256b78d' then
      return true
   else
      return false
   end
...
local auth_strat = ""
local service = {}
      if ngx.var.service_id == '2555417696872' then
        local parameters = get_auth_params("not_headers", string.split(ngx.var.request, " ")[1] )
        service = service_2555417696872 --
        ngx.var.secret_token = service.secret_token
              params.user_key = parameters["user_key"]
        get_credentials_user_key(params , service_2555417696872)
        ngx.var.cached_key = "2555417696872" .. ":" .. params.user_key
              auth_strat = "1"
        ngx.var.service_id = "2555417696872"
        ngx.var.proxy_pass = "https://cheshire"
        ngx.var.usage = extract_usage_2555417696872(ngx.var.request)
      end
